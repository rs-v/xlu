...
*to_next
[set_stand][show_skip][stop_bgm][bg_room][f_][show_stand]
[eval exp="f.act=0" ]
…[p][bgm_IF]
...
[set_dinner][d_a]
[chara_mod name="h2" time="100" storage="o/food/f-pancake.png" ]
…[p][show_dinner]
（過一會我們點的東西送上餐桌了）[p]
#希露薇
[d_at]啊，這是要給我吃的嗎？[p]
