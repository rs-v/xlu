...
[chara_mod name="h2" time="100" storage="o/food/food-a.png" ]
#希露薇
非常感謝您[p]
（希露薇靜靜的吃完了這些…）[p]
[eval exp="f.feed='pet'" ]
[jump target="*her_room" ]

*human
[cm_][set_dinner]
#
（讓她和我一起吃飯吧[l]反正做兩個人的飯和做一個人的飯是一樣的而已）[p]
[d_af][chara_mod name="h2" time="100" storage="o/food/food-b.png" ]
[show_dinner]
…[l]
...
#
（她的床[lr]家裡剛好有一間空房間）[p]
[set_stand][bg_bed][f_f][show_stand]
...
[button target="*no" graphic="ch/noidont.png" x="0" y="200" ]
[button target="*silent" graphic="ch/silent-r.png" x="0" y="350" ]
[s]

*no
[cm_][eval exp="f.trust=f.trust+1" ]
#希露薇
真的嗎？[p]
...
（無視她離開房間）[p]
#希露薇
啊…[p][black]…[p][stop_bgm]
[jump storage="intro/step1.ks" target="*show_bace" ]


*to_next
[stop_bgm][set_stand][show_skip]…[p]
[f_tf][bg_room][bgm_IF][show_stand]
