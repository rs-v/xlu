...
#希露薇
[s_t]…晚安[p]
[if exp="f.feeling>=330" ][jump storage="intro/event3.ks" target="*to_next" ][else]
#
[black]…[p][jump target="*show_bace" ][endif]
...
[elsif exp="f.talk==14" ][eval exp="f.talk=0" ][jump target="*talk14" ]
[endif]
...
*nade_lead3
[set_nade]
[if exp="f.nade==1" ][jump target="*nade1" ]
[elsif exp="f.nade==2" ][jump target="*nade2" ]
[elsif exp="f.nade==3" ][jump target="*nade3" ]
[elsif exp="f.nade==4" ][jump target="*nade4" ]
[elsif exp="f.nade==5" ][jump target="*nade5" ]
[elsif exp="f.nade==6" ][jump target="*nade6" ]
[elsif exp="f.nade==7" ][jump target="*nade7" ]
[elsif exp="f.nade==8" ][jump target="*nade8" ]
[elsif exp="f.nade==9" ][jump target="*nade9" ]
[elsif exp="f.nade==10" ][jump target="*nade10" ]
[elsif exp="f.nade==11" ][jump target="*nade11" ]
[elsif exp="f.nade==12" ][jump target="*nade12" ]
[elsif exp="f.nade==13" ][jump target="*nade13" ]
[elsif exp="f.nade==14" ][eval exp="f.nade=0" ][jump target="*nade14" ]
[endif]
