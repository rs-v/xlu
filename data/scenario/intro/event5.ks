...
*to_next
[show_skip][set_stand][bg_bed][bgm_IF][f_t]
…[p]
[show_stand]
...
似乎和平常有什麽不一樣）[p]
#希露薇
[f_ctp]雖然說過很多次了，但我還是想說非常感謝您[name]。非常非常感謝[lr]
...
[chara_mod name="under_b" time="10" storage="00.png" ]
[chara_mod name="under_p" time="10" storage="00.png" ]
#
（接吻之後，我慢慢脫掉了希露薇的衣服）[p]
...
[chara_mod name="dress" time="400" storage="00.png" ]
[chara_mod name="body" time="400" storage="s/body/s-body-a.png" ]
[chara_mod name="hair" time="400" storage="00.png" ]
