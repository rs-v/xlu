...
*ask
[show_skip][set_stand][bg_room][bgm_IF][f_ct]
…[p][show_stand]
...
[f_cclt]但是是主人您給了我溫暖給了我快樂[lr]我現在才知道什麽是幸福[p]
...
*to_next
[show_skip][set_stand][f_][bg_bed][bgm_IF]
…[p]
[show_stand]
...
[button target="*yes" graphic="ch/sleep-with.png" x="0" y="200" ]
[button target="*no" graphic="ch/cant.png" x="0" y="350" ]
[s]
