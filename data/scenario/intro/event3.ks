...
#
（我被半強迫的給希露薇買了這套衣服）[p]
[stop_bgm][set_stand][f_]
[bgm_OB]…[p][bg_town][show_stand]
...
*to_next
[show_skip][bgm_IF][set_stand][f_cclt]…[p][bg_room][show_stand]
#希露薇
早上好，咳咳…[p]
#
