...
*re
[cm_][eval exp="f.last_act='market'" ]
[chara_mod name="window" time="1" storage="00.png" ]
[chara_mod name="other" time="1" storage="00.png" ]
...
[jump target="*book_event" ]
[endif]

[iscript]
f.talk=Math.floor(Math.random() * 30 + 1);
[endscript]
[jump target="*market_lead" ]
[endif]

*choice
[cm_][eval exp="f.act=f.act+1" ][eval exp="f.love=f.love+1" ][eval exp="f.daily_market=f.daily_market+1" ]
#
[if exp="f.act==6" ]
[f_s]（星星點點的攤位進入我們的眼簾…）[p]
[jump target="*go_home" ][endif]
[chara_mod name="window" time="1" storage="o/win/out_win_s.png" ]
[set_time]
[button target="*re" graphic="s_menu/look_around.png" x="845" y="190" ]
[button target="*leave" graphic="s_menu/leave_market.png" x="845" y="270" ]
...
#
（今天就這樣結束吧）[p]
[black]…[p][bgm_SG][eval exp="f.out=1"][return_bace]

*market_lead
[cm_]
#希露薇
[if exp="f.talk==1" ][jump target="*market1" ]
[elsif exp="f.talk==2" ][jump target="*market2" ]
[elsif exp="f.talk==3" ][jump target="*market3" ]
[elsif exp="f.talk==4" ][jump target="*market4" ]
[elsif exp="f.talk==5" ][jump target="*market5" ]
[elsif exp="f.talk==6" ][jump target="*market6" ]
[elsif exp="f.talk==7" ][jump target="*market7" ]
[elsif exp="f.talk==8" ][jump target="*market8" ]
[elsif exp="f.talk==9" ][jump target="*market9" ]
[elsif exp="f.talk==10" ][jump target="*market10" ]
[elsif exp="f.talk==11" ][jump target="*market11" ]
[elsif exp="f.talk==12" ][jump target="*market12" ]
[elsif exp="f.talk==13" ][jump target="*market13" ]
[elsif exp="f.talk==14" ][jump target="*market14" ]
[elsif exp="f.talk==15" ][jump target="*market15" ]
[elsif exp="f.talk==16" ][jump target="*market16" ]
[elsif exp="f.talk==17" ][jump target="*market17" ]
[elsif exp="f.talk==18" ][jump target="*market18" ]
[elsif exp="f.talk==19" ][jump target="*market19" ]
[elsif exp="f.talk==20" ][jump target="*market20" ]
[elsif exp="f.talk==21" ][jump target="*market21" ]
[elsif exp="f.talk==22" ][jump target="*market22" ]
[elsif exp="f.talk==23" ][jump target="*market23" ]
[elsif exp="f.talk==24" ][jump target="*market24" ]
[elsif exp="f.talk==25" ][jump target="*market25" ]
[elsif exp="f.talk==26" ][jump target="*market26" ]
[elsif exp="f.talk==27" ][jump target="*market27" ]
[elsif exp="f.talk==28" ][jump target="*market28" ]
[elsif exp="f.talk==29" ][jump target="*market29" ]
[elsif exp="f.talk==30" ][jump target="*market30" ]
[elsif exp="f.talk==31" ][jump target="*market31" ]
[elsif exp="f.talk==32" ][jump target="*market32" ]
[elsif exp="f.talk==33" ][jump target="*market33" ]
[else][jump target="*book_event" ]
[endif]
...
[f_cl][jump target="*choice" ]
*market7
[f_c]人真的好多啊[lr]
[f_tp]可以、牽一下我的手嗎？[p]
[f_p][jump target="*choice" ]
*market8
[f_st]在賣各種各樣的東西呢[lr]
野菜、果物、罐頭還有其它小玩意[p]
貨架上的東西豐富多彩散發出各種味道…[p]
...
*market10
[f_st]好大的南瓜呀[p]
[f_t]不過想來想去它只能做餡餅這一種東西呢[r]
還有什麽其它做法嗎？[p]
[f_sst]如果把一個南瓜都做成餡餅的話、我和[name]是絕對吃不完的呢[p]
...
無法想象是什麽味道呢[lr]
[f_clt]雖然想嘗一嘗味道、但是這個東西的樣子真的好噁心…[p]
[f_cl][jump target="*choice" ]
*market25
...
（男人離開了）[p]
[eval exp="f.book=1" ]
[stop_bgm][bgm_AS][set_stand][f_s][bg_market][show_stand]
[chara_mod name="window" time="1" storage="00.png" ]
[chara_show name="window" time="1" wait="false" left="855" top="41" ]
[chara_mod name="sub" time="1" storage="00.png" ]
[chara_show name="sub" time="1" wait="false" left="865" top="53" ]
[jump target="*choice" ]

*leave
[cm_][stop_bgm][set_stand]…[p][f_s][bgm_OB]
