...
*meetsauce
[cm_][set_dinner][d_s]
[chara_mod name="h2" time="1" storage="o/food/d-meetsource.png" ]
...
[d_st]那么、我開動了[p]
[set_stand][f_ss][bg_restaurant][show_stand]
嗯、好吃[p]
[f_t]…誒、醬料在嘴角？[l]
[f_ct]嗯…啊咧、另一邊嗎？[p]
[f_t]嗯、是真的[p]
...
*carbonara
[cm_][set_dinner][d_s]
[chara_mod name="h2" time="1" storage="o/food/d-carbonara.png" ]
[show_dinner]（點的東西被放在餐桌上）[p]
#希露薇
...
*hamburg
[cm_][set_dinner][d_s]
[chara_mod name="h2" time="1" storage="o/food/d-hamburg.png" ]
[show_dinner]（點的東西被放在餐桌上）[p]
...
*steak
[cm_][set_dinner][d_s]
[chara_mod name="h2" time="1" storage="o/food/d-steak.png" ]
[show_dinner]（點的東西被放在餐桌上）[p]
#希露薇
...
[d_st]那麼、我開動了[p]
[set_stand][f_st][bg_restaurant][show_stand]
嗯…真好吃[p]
在家裏僅僅對肉進行烤製的話也一定沒有這麽好吃呢[lr]
準備什麼的要提前做好多吧…[p]

[else][eval exp="f.d_steak=1" ]
[d_at]牛排…這樣成塊的肉我有資格吃掉嗎…[p]
謝,谢谢[p]
[set_stand][f_][bg_restaurant][show_stand]
…[p]
[f_t]…啊、對不起、十分好吃[lr]
[f_clt]沒想到既是孤兒又身爲奴隸的我有一天竟能說出這樣的話語[r]ちょっと言葉を失ってました…。[p]
...
*rollcabbage
[cm_][set_dinner][d_s]
[chara_mod name="h2" time="1" storage="o/food/d-rollcabbage.png" ]
[show_dinner]（點的東西被放在餐桌上）[p]
#希露薇
...
*gratin
[cm_][set_dinner][d_s]
[chara_mod name="h2" time="1" storage="o/food/d-gratin.png" ]
[show_dinner]（點的東西被放在餐桌上）[p]
...
[d_at]奶汁烤菜看上去很好吃[lr]
那麼、我開動了[p]
[set_stand][f_ct][bg_restaurant][show_stand]
啊燙…[l]
[f_clt]呼—、呼—[lr]
…阿姆[p]
[f_sst]嗯、很好吃[p]
...
[if exp="f.love>=1000" ][f_sst]非常好吃[p][f_st]
[elsif exp="f.love>=200" ][f_st]非常好吃[p][f_ss]
[else][f_st]非常好吃[p][f_ss][endif]
