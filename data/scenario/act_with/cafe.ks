...
*cafe
[cm_][black][stop_bgm][copy_neck][copy_hat]

#
[if exp="f.lunch_yet==1" ]（在店裡買午飯吧）[p]
[else]（已經吃過午飯了、在晚飯前吃點零食也不錯吧）[p][endif]
...
[button target="*ch_cake" graphic="sw/ch-cake.png" x="1086" y="200" ]
[else]
[button target="*panc_" graphic="sw/pank.png" x="900" y="130" ]
[button target="*cake_" graphic="sw/cake.png" x="1086" y="130" ][endif]
[if exp="f.step>=6" ]
[button target="*french" graphic="sw/french.png" x="900" y="270" ]
...
*panc_
[cm_][set_dinner][d_a]
[chara_mod name="h2" time="1" storage="o/food/f-pancake.png" ]
...
[d_ct]…哎？是。沒有吃過[p]
[d_t]可以…吃掉它嗎？[p]
[set_stand][f_clt][bg_cafe][show_stand]
那麽、我開動了…[p]
…[p]
[f_t]…嗯、軟軟的[lr]
[f_s]…好甜[p]
...
（看來她喜歡午餐的甜食呢）[p]
#
[black]…[p][set_stand][f_clt][bg_cafe][show_stand]
#希露薇
嗯、我吃好了[p]
[f_s]十分…美味[lr]
…非常感謝您[p]
...
*cake_
[cm_][set_dinner][d_]
[chara_mod name="h2" time="1" storage="o/food/f-cake.png" ]
...
[f_s]…這上面的草莓、是一開始就吃還是最後再吃、總覺得讓人很困惑呢？[p]

[else][eval exp="f.f_cake=1" ]
[d_sat]草莓蛋糕…雖然以前見過、不過吃還是第一次呢…[lr]
[d_st]可以、吃掉它嗎？[p]
那麽…我開動了[p]
[set_stand][f_s][bg_cafe][show_stand]
...
*apple
[cm_][set_dinner][d_s]
[chara_mod name="h2" time="1" storage="o/food/f-apple.png" ]
[show_dinner]（點的東西被放到了餐桌上）[p]
#希露薇
...
*ch_cake
[cm_][set_dinner][d_s]
[chara_mod name="h2" time="1" storage="o/food/f-ch-cake.png" ]
[show_dinner]（點的東西被放到了餐桌上）[p]
#希露薇
...
[d_st]我可以、吃掉它吧？[p]
…那麽…我開動了[p]
[set_stand][f_st][bg_cafe][show_stand]
...
*french
[cm_][set_dinner][d_s]
[chara_mod name="h2" time="1" storage="o/food/f-french.png" ]
[show_dinner]（點的東西被放到了餐桌上）[p]
#希露薇
...
*pding
[cm_][set_dinner][d_s]
[chara_mod name="h2" time="1" storage="o/food/f-pding.png" ]
[show_dinner]（點的東西被放到了餐桌上）[p]
#希露薇
...
[d_sat]布丁、看起來非常好吃[lr]
[d_st]那麽…我開動了[p]
[set_stand][f_sst][bg_cafe][show_stand]
...
*parfait
[cm_][set_dinner][d_s]
[chara_mod name="h2" time="1" storage="o/food/f-parfait.png" ]
[show_dinner]（點的東西被放到了餐桌上）[p]
#希露薇
...
[f_st][name]能幫我一下嗎？、給您一點[p]
[endif][jump target="*ate" ]


*waffle
[cm_][set_dinner][d_s]
[chara_mod name="h2" time="1" storage="o/food/f-waffle.png" ]
[show_dinner]（點的東西被放到了餐桌上）[p]
#希露薇
...
[d_sat]華夫餅、看起來好吃[lr]
[d_st]乎乎…我吃了[p]
[set_stand][f_ss][bg_cafe][show_stand]
啊姆…非常美味[lr]
[f_st]上面的冰淇淋和巧克力醬[r]
只是看上去比華夫餅美味[p]
這家店的華夫餅是軟綿綿的[r]
...
[d_at]華夫餅乾…雖然知道但是、像這樣各種味道混合在一起的東西真的好吃嗎？[lr]
[d_st]可以開動嗎？[p]
[set_stand][f_s][bg_cafe][show_stand]
[f_sclt]我吃了…啊姆[p]
...
[black]
#
[if exp="f.love>=200" ]（希露薇幸福的臉、一邊吃著一邊綻開）[p]
[elsif exp="f.step>=5" ]（吃東西的希露薇的表情比往常更開朗）[p]
[elsif exp="f.step>=2" ]（希露薇一邊笨拙的吃一邊享受）[p]
[endif]
...
#希露薇
[f_scl]我吃飽了[lr]
[if exp="f.love>=200" ][f_st]非常好吃[p][f_ssp]
[elsif exp="f.step>=5" ][f_st]非常好吃[p][f_ss]
[elsif exp="f.step>=2" ][f_s]非常好吃[p][endif]

謝謝您了。[name]。
[p][paste_neck][paste_hat][eval exp="f.last_act='cafe'" ]
