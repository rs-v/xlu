...
[set_black][h_bg st="auto0-1.jpg" ]
[h_se st="H/se/auto0-1.png" ][h_tx st="H/tx/auto0-1.png" ][h_ef st="H/ef/auto0-1.png" ][h_x st="00.png" ]
...
[h_bg st="auto0-2.jpg" ][se_nloop st="squi.ogg" ]
[h_se st="H/se/auto0-2.png" ][h_tx st="H/tx/auto0-2.png" ][h_ef st="H/ef/auto0-2.png" ]
#希露薇
呀！♡…呼…♡♡嗯…♡♡♡！[p]
#
...
[h_bg st="auto0-3.jpg" ]
[h_se st="H/se/auto0-3.png" ][h_tx st="H/tx/auto0-3.png" ][h_ef st="H/ef/auto0-3.png" ]
#
...
[h_bg st="auto0-4.jpg" ]
[h_tx st="00.png" ][h_ef st="H/ef/auto0-4.png" ]
…………[p]
………哎…[name]？[p]
#
（搖搖晃晃的視線忽然望向這邊[r]
...
淚眼朦朧的視線看著我同時支起上半身）[p]
[save_dress]
[eval exp="f.dress=5" ][eval exp="f.hair=0" ][eval exp="f.pin=0" ]
[eval exp="f.neck=0" ][eval exp="f.under_p=0" ][eval exp="f.under_b=0" ]
[if exp="f.head==1 || f.head==2" ]
[else][eval exp="f.head=0" ][endif]

[set_stand][bg_bed][f_ctp][show_stand]
#希露薇
那個，我想洗衣服了…[r]
那個…[name]的襯衫…總覺得有點奇怪[p]
那個，啊…這個…[r]
我…自己也不明白…[p]
[f_ccltp]那個…對不起…對不起[p]
...
*ok
[cm][f_ctp]…心情沒有變得不好？[lr]
真的討厭我了嗎？…真的嗎？[p]
[f_ccltp]…[p]
[f_ctp]對不起…說的都亂七八糟了[p]
如果被討厭的話該怎麼辦呢？…[p]

*end
[black][stop_bgm][paste_dress][bgm_SG]
...
*cg_2
[cm][h_bg st="auto0-2.jpg" ]
[h_se st="H/se/auto0-2.png" ][h_tx st="H/tx/auto0-2.png" ][h_ef st="H/ef/auto0-2.png" ]
[h_back tg="*cg"][h_next tg="*cg_3"][s]
*cg_3
[cm][h_bg st="auto0-3.jpg" ]
[h_se st="H/se/auto0-3.png" ][h_tx st="H/tx/auto0-3.png" ][h_ef st="H/ef/auto0-3.png" ]
[h_back tg="*cg_2"][h_next tg="*cg_4"][s]
*cg_4
[cm][h_bg st="auto0-4.jpg" ]
[h_tx st="00.png" ][h_ef st="H/ef/auto0-4.png" ]
[h_back tg="*cg_3"][h_next tg="*end_cg"][s]
*end_cg
[cm][black]
